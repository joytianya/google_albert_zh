...
flags.DEFINE_string(
    "predict_dir", None,
    "The predict result data dir. Should contain the .json files (or other data files) "
    "for the task.")
...
def main(_):
  ...
  if FLAGS.do_predict:
    ...
    output_predict_file_label = os.path.join(FLAGS.predict_dir, output_predict_file_label_name)
